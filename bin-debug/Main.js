...
var Main = (function (_super) {
    ...
    Main.prototype.setUserInfo = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result1, result2, userDate, openDataContext;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, utils.login(0)];
                    case 1:
                        result1 = _a.sent();
                        return [4 /*yield*/, utils.saveUserInfo()];
                    case 2:
                        result2 = _a.sent();
                        userDate = result2['data'];
